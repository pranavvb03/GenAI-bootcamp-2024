...
def main():
  ...
  st.header("<h1 style='color: #3498db; text-align: center;'>A complete end to end PDF RAG chat application using Gemini</h1>", unsafe_allow_html=True)  # Colored header with center alignment
